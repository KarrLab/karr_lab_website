# Django settings for karrlab project.
...
ROOT_DOMAIN = 'karrlab.org'
ROOT_URL = 'http://www.' + ROOT_DOMAIN
...
ALLOWED_HOSTS = ['www.karrlab.org', 'karrlab.org']
